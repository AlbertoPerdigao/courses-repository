...
class Wallet:
    ...
    def calculate_balance(blockchain, address):
        ...
        The balance is found by adding the outpup values that belong to the address since the most recent
        ...
        for block in blockchain.chain:
            for transacion in block.data:
                if transacion['input']['address'] == address:
                    "Any time the address conducts a new transaction it resets its balance"
                    balance = transacion['output'][address]
                elif address in transacion['output']:
                    balance += transacion['output'][address]
